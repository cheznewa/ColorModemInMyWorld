...
$mode = $_POST["mode"];
exec("ffmpeg -i ".$tmp."/video -vf framerate=24,scale=720x576 ".$tmp."/%d.png ".$tmp."/a.wav");
...
{
exec("ffmpeg -r 24 -i ".$tmp."/%d_a.png -i ".$tmp."/a.wav -vcodec libx264 -f avi ".$tmp."/videodone.avi");
}
